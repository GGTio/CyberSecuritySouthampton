...
#density
hist(mydata$V1,prob=TRUE,breaks=c(0,seq(2.8,26,2.8)),ylim = c(0,0.06),xlim = c(0,24))
lines(d)
...
#PROJECT
#raw distributions
hist(mydata$V1,main = "Distribution of the times of catch",xlab = "Daytime (hours)",axes = FALSE, ylab = "Count",breaks=c(seq(0,25.2,2.8)))
axis(1,at=c(seq(0.0,24.0,4)))
axis(2,at=c(seq(0.0,35.0,5)))
boxplot(mydata$V1,horizontal = TRUE,add = TRUE, axes = FALSE, at=2.5,las=2)
axis(1,at=c(seq(0,24,4)))
hist(mydata$V2,main = "Distribution of the sizes of catch",xlab = "Weight of catches (kg)",ylab = "Count",breaks=c(0,seq(0.61,4.88,0.61)))
